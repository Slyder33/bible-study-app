...
</header><main className="max-w-4xl mx-auto">
<h2 className="text-2xl font-bold mb-4">{currentBook} Chapter {currentChapter}</h2>
...
onChange={(e) => handleNoteChange(`${currentBook}_${currentChapter}_${verse}`, e.target.value)}
/>
</div>
))}
</main>
